...
DATASET_PATH = "hf://datasets/harikbab02/Bank-Customer-Churn-2/bank_customer_churn.csv"
...
for file_path in files:
    api.upload_file(
        ...
        repo_id="hf://datasets/harikbab02/Bank-Customer-Churn-2/bank_customer_churn.csv",
        repo_type="dataset",
    )
